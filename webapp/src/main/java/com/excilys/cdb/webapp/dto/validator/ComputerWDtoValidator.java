package com.excilys.cdb.webapp.dto.validator;
...
import com.excilys.cdb.webapp.dto.exception.InvalidComputerDatesPrecedenceException;
import com.excilys.cdb.webapp.dto.exception.InvalidComputerDiscontinueDateException;
import com.excilys.cdb.webapp.dto.exception.InvalidComputerException;
import com.excilys.cdb.webapp.dto.exception.InvalidComputerIdException;
import com.excilys.cdb.webapp.dto.exception.InvalidComputerIntroductionDateException;
import com.excilys.cdb.webapp.dto.exception.InvalidComputerNameException;

@Component
public class ComputerWDtoValidator {
	
	private ComputerWDtoValidator() { }
	
	public void validate(ComputerWDto computerWDto) throws InvalidComputerException {
		validateId(computerWDto.getId());
		validateName(computerWDto.getName());
		validateIntroductionDate(computerWDto.getIntroductionDate());
		validateDiscontinueDate(computerWDto.getDiscontinueDate());
		validateDatesPrecedence(computerWDto.getIntroductionDate(), computerWDto.getDiscontinueDate());
	}
